...
![Sunlight simulator showing the house, example location, southwest-facing window, overcast weather, and current light output](assets/dashboard-sunlight-simulator.png)
...
![Device controls showing power, brightness, color temperature, color choices, and saved effects](assets/dashboard-device-controls.png)
